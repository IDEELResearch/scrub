...
# data <- data[c(11975, 14542, 14558, 14561, 14550, 14566, 14574, 14582),]
...
stave$append_data(studies_dataframe = data_stave$studies_dataframe,
                  ...
                  counts_dataframe = data_stave$counts_dataframe) # [-c(11975, 14542, 14558, 14561, 14550, 14566, 14574, 14582),])
